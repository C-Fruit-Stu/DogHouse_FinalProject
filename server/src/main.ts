...
server.use(express.json({ limit: '90000mb' })); //json עבודה עם 
// Define the CORS options
const corsOptions = {
    credentials: true,
    origin: ['http://localhost:5173', 'http://localhost:3000', 'http://localhost:7777', 'https://doghouse-finalproject.onrender.com , https://doghouse-la1b.onrender.com, http://localhost:7777/api'] // Whitelist the domains you want to allow
};
